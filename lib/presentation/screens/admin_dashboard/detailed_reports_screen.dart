  ...
  Widget build(BuildContext context) {
    ...
    Future<void> onCityChanged(String? cityId) async {
      ...
      if (cityId != null) {
        ...
        final cityCommunes =
            locationProvider.communes.where((c) => c.cityId == cityId).toList();
      ...
      body: StreamBuilder<List<AttendanceRecordModel>>(
        ...
        builder: (context, snapshot) {
          ...
          if (selectedCityId != null) {
            ...
            final citySectorCount = sectors
                .where((s) => cityCommunes.any((c) => c.id == s.communeId))
                .length;
            if (!locationProvider.isLoading && citySectorCount == 0) {
              return const Center(
                  child: Text(
                      'No hay sectores registrados para la ciudad seleccionada.'));
            }
          }
          ...
          if (selectedDateRange != null) {
            filteredRecords = filteredRecords
                .where((r) =>
                    r.date.isAfter(selectedDateRange!.start
          ...
          if (selectedCityId != null) {
            ...
            for (final commune in cityCommunes) {
              citySectorIds.addAll(sectors
                  .where((s) => s.communeId == commune.id)
                  .map((s) => s.id));
            }
            filteredRecords = filteredRecords
                .where((r) => citySectorIds.contains(r.sectorId))
                .toList();
          }
          if (selectedCommuneId != null) {
            final communeSectorIds = sectors
                .where((s) => s.communeId == selectedCommuneId)
                .map((s) => s.id)
                .toList();
            filteredRecords = filteredRecords
          ...
          for (final record in filteredRecords) {
            ...
            final total =
                record.attendedAttendeeIds.length + record.visitorCount;
          ...
          for (final record in filteredRecords) {
            final sector = sectors.firstWhere((s) => s.id == record.sectorId,
                orElse: () => Location(
                    id: '',
                    name: '',
                    communeId: '',
            ...
            final commune = communes.firstWhere((c) => c.id == sector.communeId,
                orElse: () => Commune(
                    id: '',
                    name: '',
                    cityId: '',
                    ...
                    createdAt: DateTime.now(),
                    updatedAt: DateTime.now()));
            final city = cities.firstWhere((ci) => ci.id == commune.cityId,
                orElse: () => City(
                    id: '',
                    name: '',
                    communeIds: [],
            ...
            cityCommuneAttendance[city.name]![commune.name] =
                (cityCommuneAttendance[city.name]![commune.name] ?? 0) +
          ...
          for (final record in filteredRecords) {
            ...
            communeSectorAttendance[commune.name]![sector.name] =
                (communeSectorAttendance[commune.name]![sector.name] ?? 0) +
                    record.attendedAttendeeIds.length +
                    record.visitorCount;
          }
              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('Asistencia Total por Semana (Año)',
                          style: TextStyle(fontWeight: FontWeight.bold)),
                      SizedBox(
                        height: 200,
                        child: yearWeekAttendance.isEmpty
                            ? const Center(
                                child: Text(
                                    'No hay datos de asistencia por semana.'))
                            : BarChart(
                                BarChartData(
                                  alignment: BarChartAlignment.spaceAround,
                                  maxY: yearWeekAttendance.values.isNotEmpty
                                      ? (yearWeekAttendance.values
                                              .reduce((a, b) => a > b ? a : b)
                                              .toDouble() +
                                          5)
                                      : 10,
                                  barGroups: yearWeekAttendance.entries
                        ...
                        child: BarChart(
                          BarChartData(
                            ...
                            maxY: weekAttendance.values.isNotEmpty
                                ? (weekAttendance.values
                                        .reduce((a, b) => a > b ? a : b)
                                        .toDouble() +
                                    5)
                                : 10,
                            barGroups: weekAttendance.entries
                                .map((e) => BarChartGroupData(
                                        x: e.key,
                                        barRods: [
                                          BarChartRodData(
              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('Asistencia por Ciudad y Comuna',
                          style: TextStyle(fontWeight: FontWeight.bold)),
                      ...cityCommuneAttendance.entries.map((cityEntry) =>
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(cityEntry.key,
                              ...
                              SizedBox(
                                ...
                                child: BarChart(
                                  BarChartData(
                                    alignment: BarChartAlignment.spaceAround,
                                    maxY: cityEntry.value.values.isNotEmpty
                                        ? (cityEntry.value.values
                                                .reduce((a, b) => a > b ? a : b)
                                                .toDouble() +
                                            5)
                                        : 10,
                                    barGroups: cityEntry.value.entries
                                        .map((e) => BarChartGroupData(
                                                x: cityEntry.value.keys
                                                    .toList()
                                                    .indexOf(e.key),
                                                barRods: [
                                                  BarChartRodData(
              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('Asistencia por Comuna y Sector',
                          style: TextStyle(fontWeight: FontWeight.bold)),
                      ...communeSectorAttendance.entries.map((communeEntry) =>
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(communeEntry.key,
                                  style: const TextStyle(
                                      fontWeight: FontWeight.bold)),
                              SizedBox(
                                height: 180,
                                child: BarChart(
                                  BarChartData(
                                    alignment: BarChartAlignment.spaceAround,
                                    maxY: communeEntry.value.values.isNotEmpty
                                        ? (communeEntry.value.values
                                                .reduce((a, b) => a > b ? a : b)
                                                .toDouble() +
                                            5)
                                        : 10,
                                    barGroups: communeEntry.value.entries
                                        .map((e) => BarChartGroupData(
                                                x: communeEntry.value.keys
                                                    .toList()
                                                    .indexOf(e.key),
                                                barRods: [
                                                  BarChartRodData(
